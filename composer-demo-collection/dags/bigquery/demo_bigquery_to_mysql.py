...
with DAG(
    ...
    description="This Airflow DAG creates an empty dataset in BigQuery, creates a table, transfers the data to MySQL, and then deletes the dataset.",
    tags=["demo", "google_cloud", "bigquery", "mysql"],
) as dag:
    ...
    create_dataset >> create_table >> bigquery_to_mysql >> [delete_dataset, end]
