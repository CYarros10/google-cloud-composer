...
IMAGE_DATA_CONFIG = [
    {
        ...
        "gcs_source": {
            "uris": [
                f"gs://{IMAGE_GCS_BUCKET_NAME}/automl/image-dataset-classification.csv"
            ]
        },
    }
]
with DAG(
    ...
    description=" This DAG trains an AutoML image classification model using Vertex AI and cleans up resources.",
