...
with DAG(
    ...
    description="This DAG creates and manages a Cloud Bigtable instance: it creates and updates the instance, creates and then deletes a table, and finally deletes the instance.",
    tags=["demo", "google_cloud", "bigtable"],
) as dag:
