...
with DAG(
    ...
    description="This DAG tests the BigQueryToGCSOperator by creating a dataset, table, GCS bucket, transferring data, and then deleting the resources. ",
