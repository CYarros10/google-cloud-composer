...
from utils.tooling import local_config_from_local


DAG_PATH = '/home/airflow/gcs/dags/'
config = local_config_from_local(
    path=os.path.join(DAG_PATH, 'local_configs/local.yaml')
)
...
with models.DAG(
    dag_id=f"local_config_dag_v0_2",
